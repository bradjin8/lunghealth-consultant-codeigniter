	...
	*/
	...
	function fn_TherapyMessage($arrInputs = array()) {		
		...
		*/			
		...
		if ($msgCode == "K"){ 
			$msgText = "<p>This patient reports poor control on a low dose of inhaled steroid ".$CurrentStep2Drug." (Step 2). As control was ".strtolower($ControlLastTime)." last time, consider increasing the dose of inhaler steroid or switching to an ICS/LABA combination inhaler and plan to review earlier than one year to assess whether this step up of therapy should be maintained permanently.</p>";
		}
