...
class FlowAlgorithmsLibrary extends FlowLibrary {
	...
	******************************************************************/  
	...
	//fn_SpiroOrPEFFlow("AssessmentDetails,AssessmentType","LungFunction,LungFunctionOutcome","Spirometry,MaximumEffort","LungFunction,LungFunctionPerformed","Exacerbation,PEFNotAvailable",1008,5004,20000) - FieldID: 2246	
	public function fn_SpiroOrPEFFlow($arrInputs = array()) {
		...
		} elseif ($LungFunctionOutcome == "Spirometry performed - Restrictive" || $MaximumEffort == "N" || substr($LungFunctionOutcome,0,5) == "Error" || $Exacerbation_PEFNotAvailable == "Y") {
			return $ExitFlow;
		} else {
			$CI = & get_instance();
