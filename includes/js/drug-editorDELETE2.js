...
function agcBuildModeSelector(strName)
{
	...
	drugWarningFunctionNames = "agc_calc_WarningMoreThanOneLama("+objValues.attr('data-agcchangetype')+");agc_calc_WarningMoreThanOneLaba('"+objValues.attr('data-agcchangetype')+"');agc_calc_WarningDrugsWithoutICS();";
