...
function agcBuildModeSelector(strName)
{
	...
	drugWarningFunctionNamesStop = "agc_calc_WarningMoreThanOneLama('"+strName+"stop');agc_calc_WarningMoreThanOneLaba('"+strName+"stop');agc_calc_WarningDrugsWithoutICS('"+strName+"stop');";
	drugWarningFunctionNamesChange = "agc_calc_WarningMoreThanOneLama('"+strName+"changetherapy');agc_calc_WarningMoreThanOneLaba('"+strName+"changetherapy');agc_calc_WarningDrugsWithoutICS('"+strName+"changetherapy');";
