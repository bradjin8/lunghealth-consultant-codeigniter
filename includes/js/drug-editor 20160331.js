...
function agcBuildModeSelector(strName)
{
	...
	drugWarningFunctionNames = "agc_calc_WarningMoreThanOneLama();agc_calc_WarningMoreThanOneLaba();agc_calc_WarningDrugsWithoutICS();";
        ...
        strModeSelector += '<div class="btn-group form-group" data-toggle="buttons">'+
                ...
                strModeSelector += '" onClick="javascript:agcInsertDrugDropDowns(\''+strName+'\',\'changetherapy\',\'edit\');agcInsertReasonField(\''+strName+'\');'+drugWarningFunctionNames+'">'+
        ...
        strModeSelector += '/> Change Dose/Device'+
                ...
                strModeSelector += '"  onClick="javascript:agcStopTherapy(\''+strName+'\');agcInsertReasonField(\''+strName+'\');'+drugWarningFunctionNames+'">'+
	...
	if(typeof objDrugs['Drug'+strDrug][strSelectedDrug] !== 'undefined')
	{
		...
		{    
			...
			//{
				...
				{
					strOptionSelect += ' onChange="'+strDatabaseFunction+';"';
				}
                strOptionSelect += '>';
