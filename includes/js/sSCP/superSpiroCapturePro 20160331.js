...
(function($) {
  ...
  $.fn[_sSCP] = function() {
      ...
      function calculatePredictions()
      {
          ...
          /*
          console.log(_sSCPAge);
          console.log(_sSCPPredPef);
          console.log(_sSCPPredFvc);
          console.log(_sSCPPredFev);
          */
      }
      ...
      function captureSpiroData()
      {
          ...
          $.post( "/api/addSpirometry/"+patientId, 
                    ...
                    function(data) {
                        if (data.error === false)
                        {
                            //console.log('OKAY, DATA CAPTURED');
                        ...
                        {
                            //console.log('ERROR DATA REJECTED');
