...
function agcBuildModeSelector(strName)
{
	...
	drugWarningFunctionNamesStop = "agc_calc_WarningMoreThanOneLama('stop');agc_calc_WarningMoreThanOneLaba();agc_calc_WarningDrugsWithoutICS('stop');";
	drugWarningFunctionNamesChange = "agc_calc_WarningMoreThanOneLama('changetherapy');agc_calc_WarningMoreThanOneLaba();agc_calc_WarningDrugsWithoutICS('changetherapy');";
