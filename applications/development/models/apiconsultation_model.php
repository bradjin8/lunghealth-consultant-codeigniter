...
{   
    ...
    protected function createConsultation($objReview)
    {
        ...
        if ($this->instantiateConsultation($arrConsultationData))
        {
            ...
            */
            ...
            /*$objRoot        = ;*/
            $r = $this->resObjectConsultation->data->query($strQuery)->item(0)->getElementsByTagName("ConsultationId")->item(0)->nodeValue;
            return $r;
        }
        else
        {
    ...
    public function sendConsultationToApi($objReview)
    {
        ...
        $this->apiConsultationId = $intApiConsultationId;
