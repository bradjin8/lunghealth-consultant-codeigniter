...
class Review_Model extends CI_Model {
    ...
    function doSetupAPISession($objApiPatient)
    {
        ...
        $this->_data['InitialPatientDetails_EvaluateData']  = $objApiPatient->EvaluateData;
        $this->_data['InitialPatientDetails_Research']      = $objApiPatient->Research;

		
		$this->_data['AssessmentDetails_ConsultationEndDate']   = date('jS F Y');
    ...
    function doImportPreviousConsultation($objApiPatient)
    {
		...
		//var_dump($objApiPatient->PatientId);
        //die();
		
        $arrPreviousConsultations = $CI->apiconsultation->getPreviousCompletedConsultationsFor($objApiPatient->PatientId);
        
		//error_log( print_r( $arrPreviousConsultations, true ) );
        //var_dump($arrPreviousConsultations);
