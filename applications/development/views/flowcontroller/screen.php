    ...
    ?>" id="qg-holder-<?php echo $objQuestionGroup->QuestionGroupID; ?>">
        <div class="panel-heading">
            ...
            if (($intFlowID >= 20000) && ($intScreenFlowPosition === ($intFlowScreenCount - 1))) {
                ?><a href="<?php echo site_url('download/pdf'); ?>" id="btnDownloadAsPDF"
                     class="rounded-button-purple right" value="true"><span>Download as PDF &nbsp;&nbsp;<span
                                class="glyphicon glyphicon-floppy-disk"></span></span></a><?php
            } else {
                if ($intFlowID >= 19000) {
                    ?><a href="<?php echo site_url('download/previous_pdf'); ?>" id="btnDownloadAsPDF"
                         class="rounded-button-purple right" value="true"><span>Download as PDF &nbsp;&nbsp;<span
                                    class="glyphicon glyphicon-floppy-disk"></span></span></a><?php
                }
            }
                                            ...
                                            switch ($objTable->TableType) {
                                                case "data_json":
                                                    ...
                                                    <ul class="nav nav-tabs"
                                                        id="agcTab_<?php echo $objTable->TableID; ?>" role="tablist">
                                                        <li><a href="#agcTab_<?php echo $objTable->TableID; ?>_chart"
                                                               role="tab" data-toggle="tab"><span
                                                                        class="glyphicon glyphicon-stats"></span> Chart</a>
                                                        </li>
                                                        <li class="active"><a
                                                                    href="#agcTab_<?php echo $objTable->TableID; ?>_table"
                                                                    role="tab" data-toggle="tab"><span
    ...
    if ($CI->session->userdata('booAudit') === true) {
        ...
        <div class="col-md-2">
            <ul class="pager">
                <li>
                    ...
                    if ($strPrevPage !== '') {
                        ?>
                        <a href="/flowcontroller/screen/<?php echo $strPrevPage; ?>"><span
        ...
        <div class="col-md-8">
            <ul class="pager">
                ...
                <li>
                    <a href="/begin/auditcleanup/<?php echo $this->input->cookie('agc_APIVars_token'); ?>">Finish <span
        ...
        if ($strNextPage !== '') {
            ...
            <div class="col-md-2">
                <ul class="pager">
                    <li>
                        <a href="/flowcontroller/screen/<?php echo $strNextPage; ?>">Next <span
            ...
            <ul class="pager">
                <li>
                    ...
                    if ($strPreviousScreen !== '') {
                        ?>
                        <button name="btnFormSubmitPrev" id="btnFormSubmitPrev" value="true"
                                onClick="javascript:agc_setForSubmit('<?php echo $strPreviousScreen ?>');"><span
        ...
        <div class="col-md-8">
            <ul class="pager">
                ...
                if (($intFlowID < 20000) || ($intScreenFlowPosition != ($intFlowScreenCount - 1))) {
                    ...
                    <li>
                        <button name="btnFormSubmitAbandon" id="btnFormSubmitAbandon" value="true"
                                onClick="javascript:agc_setForSubmit('ABANDON');"><span
                                    class="glyphicon glyphicon-new-window"></span> Save & Exit
                        </button>
                    </li>
        ...
        <div class="col-md-2">
            <ul class="pager">
                <li>
                    <button type="submit" name="btnFormSubmitNext" id="btnFormSubmitNext" class="no-validate"
                            value="true"><?php
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" id="agc_modal_body">
                <p>That change made some answers disappear. Would you like to confirm this and remove the answers, or
                    undo and reinstate them?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" id="agc_modal_dialog_proceed" data-dismiss="modal"><span
                            class="glyphicon glyphicon-exclamation-sign"></span> Confirm
                </button>
                <button type="button" class="btn btn-primary" id="agc_modal_dialog_reset" data-dismiss="modal"><span
                            class="glyphicon glyphicon-refresh"></span> Undo
                </button>
...
<div class="modal fade" id="agc_modal_dialog_invalid">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" id="agc_modal_invalid_ignore" data-dismiss="modal"><span
                            class="glyphicon glyphicon-trash"></span> Submit Anyway
                </button>
                <button type="button" class="btn btn-primary" id="agc_modal_invalid_undo" data-dismiss="modal"><span
                            class="glyphicon glyphicon-wrench"></span> I'll Fix It
                </button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group">
                        <label class='radio-inline'><input type="radio" name="agc_modal_pefbest_response"
                                                           id="agc_modal_pefbest_response_yes" value="YES"
                                                           checked='checked'/> Yes</label>
                        <label class='radio-inline'><input type="radio" name="agc_modal_pefbest_response"
                                                           id="agc_modal_pefbest_response_no" value="NO"/> No</label>
                    </div>
                </div>
                <div class="row hidden" id="agc_modal_pefbest_furtherquestion">
                    <div class="form-group">
                        <label class='radio-inline'>Please enter the patient's best known PEF <input type="text"
                                                                                                     name="agc_modal_pefbest_pef_value"
                                                                                                     id="agc_modal_pefbest_pef_value"/></label>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="agc_modal_pefbest_okay" data-dismiss="modal"><span
                            class="glyphicon glyphicon-ok"></span> Okay
                </button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
<div id="agc_modal_loader" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog"
