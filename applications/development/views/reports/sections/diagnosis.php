<?php
	...
	if(	   $objReview->DiagnosisBasis_BeenOnInhalersSinceChildhood == "Y" 
		...
		if($objReview->FirstAssessment_AsthmaRegister2006 == "Y"){
			$DiagnosisBasisText .="<li>Patient has been on the Asthma Register since before 2006</li>";
		}
		
		if($objReview->DiagnosisBasis_SymptomsPresentSinceChildhood == "Y"){
			$DiagnosisBasisText .="<li>Patient has had asthma symptoms since childhood</li>";
		}
		...
		if($objReview->DiagnosisBasis_HospitalReport == "Y"){
			$DiagnosisBasisText .="<li>There is a record of a hospital report for this patient, confirming a diagnosis of asthma. The hospital report shows:</li>";	
			$DiagnosisBasisText .="<i>" . nl2br($objReview->FirstAssessment_HospitalReportDetails) . "</i>";	
		}
	...
	if(	   $objReview->DiagnosisBasis_ChestCold == "Y" 
		...
		if($objReview->DiagnosisBasis_TriggersAny == "Y"){
			...
			if($objReview->DiagnosisBasis_TriggersOther == "Y"){
				$DiagnosisBasisText .="<li>Other: <i>".$objReview->FirstAssessment_TriggersOtherDetails."</i></li>";
			}
